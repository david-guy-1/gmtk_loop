...
define("process_draws", ["require", "exports", "canvasDrawing"], function (require, exports, canvasDrawing_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.img_with_center = void 0;
    exports.draw = draw;
    exports.clear = clear;
    exports.draw_wrap = draw_wrap;
    ...
    function draw_wrap(lst, c) {
        for (let item of lst) {
            switch (item.type) {
                case "drawImage":
                    (0, canvasDrawing_1.drawImage)(c, item.img, item.x, item.y);
                    break;
                case "drawLine":
                    (0, canvasDrawing_1.drawLine)(c, item.x0, item.y0, item.x1, item.y1, item.color, item.width);
                    break;
                case "drawCircle":
                    (0, canvasDrawing_1.drawCircle)(c, item.x, item.y, item.r, item.color, item.width, item.fill, item.transparency, item.start, item.end);
                    break;
                case "drawPolygon":
                    (0, canvasDrawing_1.drawPolygon)(c, item.points_x, item.points_y, item.color, item.width, item.fill, item.transparency);
                    break;
                case "drawRectangle":
                    (0, canvasDrawing_1.drawRectangle)(c, item.tlx, item.tly, item.brx, item.bry, item.color, item.width, item.fill, item.transparency);
                    break;
                case "drawRectangle2":
                    (0, canvasDrawing_1.drawRectangle2)(c, item.tlx, item.tly, item.width, item.height, item.color, item.widthA, item.fill, item.transparency);
                    break;
                case "drawText":
                    (0, canvasDrawing_1.drawText)(c, item.text_, item.x, item.y, item.width, item.color, item.size, item.font);
                    break;
                case "drawEllipse":
                    (0, canvasDrawing_1.drawEllipse)(c, item.posx, item.posy, item.brx, item.bry, item.color, item.transparency, item.rotate, item.start, item.end);
                    break;
                case "drawEllipseCR":
                    (0, canvasDrawing_1.drawEllipseCR)(c, item.cx, item.cy, item.rx, item.ry, item.color, item.transparency, item.rotate, item.start, item.end);
                    break;
                case "drawEllipse2":
                    (0, canvasDrawing_1.drawEllipse2)(c, item.posx, item.posy, item.width, item.height, item.color, item.transparency, item.rotate, item.start, item.end);
                    break;
                case "drawBezierCurve":
                    (0, canvasDrawing_1.drawBezierCurve)(c, item.x, item.y, item.p1x, item.p1y, item.p2x, item.p2y, item.p3x, item.p3y, item.color, item.width);
                    break;
                case "drawBezierShape":
                    (0, canvasDrawing_1.drawBezierShape)(c, item.x, item.y, item.curves, item.color, item.width);
                    break;
                case "drawRoundedRectangle":
                    (0, canvasDrawing_1.drawRoundedRectangle)(c, item.x0, item.y0, item.x1, item.y1, item.r1, item.r2, item.color, item.width, item.fill);
                    break;
            }
        }
    }
    ...
    exports.img_with_center = img_with_center;
